      ...
      <section className="cultural-activities py-12">
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-8 items-center">
          <div className="text-section">
            <h2 className="text-4xl font-bold mb-4 text-orange-500">{translations[language].heading}</h2>
            ...
            <a href="#" className="bg-orange-500 hover:bg-orange-600 text-white py-2 px-6 rounded-lg text-lg font-semibold">
              {translations[language].readMore}
            </a>
            <div className="mt-8 flex items-center">
              <img className="w-12 h-12 rounded-full mr-4" src="../../IMG/Principleimage.jpg" alt={translations[language].ceoName} />
              <div>
                <h4 className="text-xl font-bold text-orange-500">{translations[language].ceoName}</h4>
                <p className="text-gray-600">{translations[language].ceoTitle}</p>
              </div>
            </div>
          </div>
